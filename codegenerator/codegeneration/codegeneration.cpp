...
string traverseGenerate(Node* currentNode, int depth)
{
    ...
    {
        result = generateString(currentNode, result, depth, tp, input, fontAlign, font, fontSize, tabPosition);
    }
    if(currentNode->getType() == VARIABLE)
    {
        result = generateVariable(currentNode, result, depth, tp, input, fontAlign, font, fontSize, tabPosition);
    }
    if(currentNode->getType() == NUMBER)
    {
        result = generateNumber(currentNode, result, depth, tp, input, fontAlign, font, fontSize, tabPosition);
    }
    ...
    if(currentNode->getType() == NEWLINE)
    {
        ...
        result = generateNewLine(currentNode, result, depth);
    }
